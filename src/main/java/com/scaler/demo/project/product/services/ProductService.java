...
import com.scaler.demo.project.product.mapper.ProductMapper;
...
public class ProductService implements IProductService {
    ...
    public Product addProduct(AddProductRequest request) {
        if (productExists(request.getName(), request.getBrand())){
            throw new RecordPresentException(request.getBrand() +" "+request.getName()+ " already exists, you may update this product instead!");
        }
    ...
    public ProductDto convertToDto(Product product) {
        ProductDto productDto = modelMapper.convertToDto(product);
